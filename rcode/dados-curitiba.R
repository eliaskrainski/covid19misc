...
djj <- c(
    paste0('202101', sprintf('%02d', 27:31)),
    paste0('202102', sprintf('%02d', 1:4)))
...
t3a[jj, ] <- cbind(
    ...
    c(##52084, 52238, 52484, 52704, 53342, 54013, 54695,
        ...
        117369,118214,119011,
        119654,119800,120129,120863,121396,122121))
