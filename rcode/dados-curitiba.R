...
djj <- c(
    paste0('202102', sprintf('%02d', 24:28)),
    paste0('202103', sprintf('%02d', 1:9)))
...
t3a[jj, ] <- cbind(
    ...
    c(##1559, 1564, 1569, 1582, 1593, 1602, 1613,
        ...
        2867,2887,2905,2923,2934,2944,2961,2980,3000,
        3020,3042,3058,3074,3094),
    c(##52084, 52238, 52484, 52704, 53342, 54013, 54695,
        ...
        129620,129976,130605,131050,131400,131631,132423,132905,
        134052,134674,135234,135300,135638,136435))
