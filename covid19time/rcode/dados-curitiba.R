...
(jj <- pmatch(c(##paste0('202011', 28:30),
     ...
     paste0('202101', sprintf('%02d', 15:25))), 
     colnames(t3)))
t3a[jj, ]
...
t3a[jj, ] <- cbind(
    c(##5705, 6449, 6849, 7449, 7714, 8415, 9131,
        ...
        8466,8714,9000,9149,8993,8743,8295,7846,
        7919,7800,7207),
    c(##1559, 1564, 1569, 1582, 1593, 1602, 1613,
        ...
        2439,2458,2469,2479,2499,2518,2530,2537,
        2549,2555,2563),
    c(##52084, 52238, 52484, 52704, 53342, 54013, 54695,
        ...
        109624,110196,110400,110526,111506,112440,113372,114220,
        114576,115000,115865))
