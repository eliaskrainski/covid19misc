...
djj <- c(##paste0('202011', 28:30),
    ##paste0('202012', sprintf('%02d', 31)),
    paste0('202101', sprintf('%02d', 22:29)))
...
t3a[jj, ] <- cbind(
    ...
    c(##1559, 1564, 1569, 1582, 1593, 1602, 1613,
        ...
        2537,2549,2555,2563,2574,2585,2592,2603),
    c(##52084, 52238, 52484, 52704, 53342, 54013, 54695,
        ...
        114220,114576,115000,115865,116662,117369,118214,119011))
